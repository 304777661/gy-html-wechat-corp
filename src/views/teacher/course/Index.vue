...
<script>
  export default {
    ...
    created () {
      // Promise.all([this.$api.teacher.queryCourseSectionSetList(), this.$api.teacher.queryPersonalTimetable()]).then(res => {
      //   this.termName = res[1].termName
      //   let sectionData = res[0]
      //   // let courseData = res[1].courseTimetableDetails.sort((a, b) => {
      //   //   return a.sectionId - b.sectionId
      //   // })
      //   let courseData = res[1].courseTimetableDetails
